...
const localPrepositionsDativeCards=[
  {id:"local-dative-in-schublade",targetId:"local-dative-in-schublade",type:"cloze",word:"in der Schublade",translation:"у шухляді",promptText:"Das Buch liegt ___.",support:"Wo? Місце без напрямку.",response:{mode:"text",scope:"phrase",accepted:["in der Schublade"],caseSensitive:false,punctuationSensitive:false},explanation:"Wo? expresses a position, so in takes Dativ: die Schublade → der Schublade.",example:"Die Schlüssel sind in der Schublade.",exampleTranslation:"Ключі в шухляді.",category:"LOKALE PRÄPOSITIONEN · WO?"},
  {id:"local-dative-an-wand",targetId:"local-dative-an-wand",type:"cloze",word:"an der Wand",translation:"на стіні",promptText:"Das Bild hängt ___.",support:"Wo? Місце без напрямку.",response:{mode:"text",scope:"phrase",accepted:["an der Wand"],caseSensitive:false,punctuationSensitive:false},explanation:"A picture already hangs in one place, so an takes Dativ: die Wand → der Wand.",example:"Neben der Tür hängt ein Kalender an der Wand.",exampleTranslation:"Біля дверей на стіні висить календар.",category:"LOKALE PRÄPOSITIONEN · WO?"},
  {id:"local-dative-auf-tisch",targetId:"local-dative-auf-tisch",type:"cloze",word:"auf dem Tisch",translation:"на столі",promptText:"Die Zeitung liegt ___.",support:"Wo? Місце без напрямку.",response:{mode:"text",scope:"phrase",accepted:["auf dem Tisch"],caseSensitive:false,punctuationSensitive:false},explanation:"The newspaper is already on the surface, so auf takes Dativ: der Tisch → dem Tisch.",example:"Auf dem Tisch steht auch eine Tasse Kaffee.",exampleTranslation:"На столі також стоїть чашка кави.",category:"LOKALE PRÄPOSITIONEN · WO?"},
  {id:"local-dative-ueber-bett",targetId:"local-dative-ueber-bett",type:"cloze",word:"über dem Bett",translation:"над ліжком",promptText:"Die Lampe hängt ___.",support:"Wo? Місце без напрямку.",response:{mode:"text",scope:"phrase",accepted:["über dem Bett"],caseSensitive:false,punctuationSensitive:false},explanation:"The lamp has a fixed position, so über takes Dativ: das Bett → dem Bett.",example:"Über dem Bett hängt eine kleine Lampe.",exampleTranslation:"Над ліжком висить маленька лампа.",category:"LOKALE PRÄPOSITIONEN · WO?"},
  {id:"local-dative-unter-stuhl",targetId:"local-dative-unter-stuhl",type:"cloze",word:"unter dem Stuhl",translation:"під стільцем",promptText:"Der Hund liegt ___.",support:"Wo? Місце без напрямку.",response:{mode:"text",scope:"phrase",accepted:["unter dem Stuhl"],caseSensitive:false,punctuationSensitive:false},explanation:"The dog is already in a position, so unter takes Dativ: der Stuhl → dem Stuhl.",example:"Unter dem Stuhl schläft der Hund.",exampleTranslation:"Під стільцем спить собака.",category:"LOKALE PRÄPOSITIONEN · WO?"},
  {id:"local-dative-vor-haus",targetId:"local-dative-vor-haus",type:"cloze",word:"vor dem Haus",translation:"перед будинком",promptText:"Die Bank steht ___.",support:"Wo? Місце без напрямку.",response:{mode:"text",scope:"phrase",accepted:["vor dem Haus"],caseSensitive:false,punctuationSensitive:false},explanation:"The bench is already there, so vor takes Dativ: das Haus → dem Haus.",example:"Vor dem Haus wartet ein Taxi.",exampleTranslation:"Перед будинком чекає таксі.",category:"LOKALE PRÄPOSITIONEN · WO?"},
  {id:"local-dative-hinter-haus",targetId:"local-dative-hinter-haus",type:"cloze",word:"hinter dem Haus",translation:"за будинком",promptText:"Das Auto steht ___.",support:"Wo? Місце без напрямку.",response:{mode:"text",scope:"phrase",accepted:["hinter dem Haus"],caseSensitive:false,punctuationSensitive:false},explanation:"The car has a fixed position, so hinter takes Dativ: das Haus → dem Haus.",example:"Hinter dem Haus ist ein Parkplatz.",exampleTranslation:"За будинком є парковка.",category:"LOKALE PRÄPOSITIONEN · WO?"},
  {id:"local-dative-neben-studentin",targetId:"local-dative-neben-studentin",type:"cloze",word:"neben der Studentin",translation:"біля студентки",promptText:"Er sitzt ___.",support:"Wo? Місце без напрямку.",response:{mode:"text",scope:"phrase",accepted:["neben der Studentin"],caseSensitive:false,punctuationSensitive:false},explanation:"He is already sitting there, so neben takes Dativ: die Studentin → der Studentin.",example:"Neben der neuen Studentin sitzt ihr Freund.",exampleTranslation:"Біля нової студентки сидить її друг.",category:"LOKALE PRÄPOSITIONEN · WO?"},
  {id:"local-dative-zwischen-fenstern",targetId:"local-dative-zwischen-fenstern",type:"cloze",word:"zwischen den Fenstern",translation:"між вікнами",promptText:"Das Bild hängt ___.",support:"Wo? Місце без напрямку.",response:{mode:"text",scope:"phrase",accepted:["zwischen den Fenstern"],caseSensitive:false,punctuationSensitive:false},explanation:"The picture is already positioned there, so zwischen takes Dativ plural: die Fenster → den Fenstern.",example:"Zwischen den Fenstern hängt ein Bild.",exampleTranslation:"Між вікнами висить картина.",category:"LOKALE PRÄPOSITIONEN · WO?"}
];
const localPrepositionsAccusativeCards=[
  {id:"local-accusative-in-schublade",targetId:"local-accusative-in-schublade",type:"cloze",word:"in die Schublade",translation:"у шухляду",promptText:"Er legt das Buch ___.",support:"Wohin? Напрямок до місця.",response:{mode:"text",scope:"phrase",accepted:["in die Schublade"],caseSensitive:false,punctuationSensitive:false},explanation:"Wohin? expresses a destination, so in takes Akkusativ: die Schublade → die Schublade.",example:"Sie legt den Löffel in die Schublade.",exampleTranslation:"Вона кладе ложку в шухляду.",category:"LOKALE PRÄPOSITIONEN · WOHIN?"},
  {id:"local-accusative-an-wand",targetId:"local-accusative-an-wand",type:"cloze",word:"an die Wand",translation:"на стіну",promptText:"Er hängt das Bild ___.",support:"Wohin? Напрямок до місця.",response:{mode:"text",scope:"phrase",accepted:["an die Wand"],caseSensitive:false,punctuationSensitive:false},explanation:"The picture moves to the wall, so an takes Akkusativ: die Wand → die Wand.",example:"Ich hänge das Poster an die Wand.",exampleTranslation:"Я вішаю плакат на стіну.",category:"LOKALE PRÄPOSITIONEN · WOHIN?"},
  {id:"local-accusative-auf-tisch",targetId:"local-accusative-auf-tisch",type:"cloze",word:"auf den Tisch",translation:"на стіл",promptText:"Ich stelle die Vase ___.",support:"Wohin? Напрямок до місця.",response:{mode:"text",scope:"phrase",accepted:["auf den Tisch"],caseSensitive:false,punctuationSensitive:false},explanation:"The vase moves onto the surface, so auf takes Akkusativ: der Tisch → den Tisch.",example:"Stell bitte die Gläser auf den Tisch.",exampleTranslation:"Будь ласка, постав склянки на стіл.",category:"LOKALE PRÄPOSITIONEN · WOHIN?"},
  {id:"local-accusative-ueber-bett",targetId:"local-accusative-ueber-bett",type:"cloze",word:"über das Bett",translation:"над ліжко",promptText:"Ich hänge die Lampe ___.",support:"Wohin? Напрямок до місця.",response:{mode:"text",scope:"phrase",accepted:["über das Bett"],caseSensitive:false,punctuationSensitive:false},explanation:"The lamp is moved to a new position, so über takes Akkusativ: das Bett → das Bett.",example:"Der Vater hängt die Lampe über das Bett.",exampleTranslation:"Тато вішає лампу над ліжком.",category:"LOKALE PRÄPOSITIONEN · WOHIN?"},
  {id:"local-accusative-unter-stuhl",targetId:"local-accusative-unter-stuhl",type:"cloze",word:"unter den Stuhl",translation:"під стілець",promptText:"Der Hund legt sich ___.",support:"Wohin? Напрямок до місця.",response:{mode:"text",scope:"phrase",accepted:["unter den Stuhl"],caseSensitive:false,punctuationSensitive:false},explanation:"The dog moves there, so unter takes Akkusativ: der Stuhl → den Stuhl.",example:"Die Katze läuft unter den Stuhl.",exampleTranslation:"Кішка біжить під стілець.",category:"LOKALE PRÄPOSITIONEN · WOHIN?"},
  {id:"local-accusative-vor-haus",targetId:"local-accusative-vor-haus",type:"cloze",word:"vor das Haus",translation:"перед будинок",promptText:"Wir stellen die Bank ___.",support:"Wohin? Напрямок до місця.",response:{mode:"text",scope:"phrase",accepted:["vor das Haus"],caseSensitive:false,punctuationSensitive:false},explanation:"The bench is moved to that place, so vor takes Akkusativ: das Haus → das Haus.",example:"Sie stellen die Fahrräder vor das Haus.",exampleTranslation:"Вони ставлять велосипеди перед будинком.",category:"LOKALE PRÄPOSITIONEN · WOHIN?"},
  {id:"local-accusative-hinter-haus",targetId:"local-accusative-hinter-haus",type:"cloze",word:"hinter das Haus",translation:"за будинок",promptText:"Wir parken das Auto ___.",support:"Wohin? Напрямок до місця.",response:{mode:"text",scope:"phrase",accepted:["hinter das Haus"],caseSensitive:false,punctuationSensitive:false},explanation:"The car is moved to a destination, so hinter takes Akkusativ: das Haus → das Haus.",example:"Fahr bitte hinter das Haus.",exampleTranslation:"Будь ласка, їдь за будинок.",category:"LOKALE PRÄPOSITIONEN · WOHIN?"},
  {id:"local-accusative-neben-studentin",targetId:"local-accusative-neben-studentin",type:"cloze",word:"neben die Studentin",translation:"біля студентки",promptText:"Er setzt sich ___.",support:"Wohin? Напрямок до місця.",response:{mode:"text",scope:"phrase",accepted:["neben die Studentin"],caseSensitive:false,punctuationSensitive:false},explanation:"He moves to a seat there, so neben takes Akkusativ: die Studentin → die Studentin.",example:"Der Student setzt sich neben die Lehrerin.",exampleTranslation:"Студент сідає біля вчительки.",category:"LOKALE PRÄPOSITIONEN · WOHIN?"},
  {id:"local-accusative-zwischen-fenster",targetId:"local-accusative-zwischen-fenster",type:"cloze",word:"zwischen die Fenster",translation:"між вікна",promptText:"Ich hänge das Bild ___.",support:"Wohin? Напрямок до місця.",response:{mode:"text",scope:"phrase",accepted:["zwischen die Fenster"],caseSensitive:false,punctuationSensitive:false},explanation:"The picture moves to its destination, so zwischen takes Akkusativ plural: die Fenster → die Fenster.",example:"Häng den Spiegel zwischen die Fenster.",exampleTranslation:"Повісь дзеркало між вікнами.",category:"LOKALE PRÄPOSITIONEN · WOHIN?"}
];
const localPrepositionsContrastCards=[
  {id:"local-contrast-vase",targetId:"local-contrast-vase",type:"sentence-build",word:"Ich stelle die Vase auf den Tisch.",translation:"Я ставлю вазу на стіл.",promptText:"die Vase / auf den Tisch / ich / stelle",response:{mode:"text",scope:"sentence",accepted:["Ich stelle die Vase auf den Tisch."],caseSensitive:false,punctuationSensitive:false},explanation:"Stellen answers Wohin?, so use auf + Akkusativ: auf den Tisch.",example:"Die Vase steht auf dem Tisch.",exampleTranslation:"Ваза стоїть на столі.",category:"LOKALE PRÄPOSITIONEN · SATZBAU"},
  {id:"local-contrast-vase-position",targetId:"local-contrast-vase-position",type:"sentence-build",word:"Die Vase steht auf dem Tisch.",translation:"Ваза стоїть на столі.",promptText:"auf dem Tisch / die Vase / steht",response:{mode:"text",scope:"sentence",accepted:["Die Vase steht auf dem Tisch."],caseSensitive:false,punctuationSensitive:false},explanation:"Stehen answers Wo?, so use auf + Dativ: auf dem Tisch.",example:"Ich stelle die Vase auf den Tisch.",exampleTranslation:"Я ставлю вазу на стіл.",category:"LOKALE PRÄPOSITIONEN · SATZBAU"},
  {id:"local-contrast-picture",targetId:"local-contrast-picture",type:"sentence-build",word:"Er hängt das Bild an die Wand.",translation:"Він вішає картину на стіну.",promptText:"an die Wand / das Bild / er / hängt",response:{mode:"text",scope:"sentence",accepted:["Er hängt das Bild an die Wand."],caseSensitive:false,punctuationSensitive:false},explanation:"Hängen here describes movement to the wall, so an takes Akkusativ.",example:"Das Bild hängt an der Wand.",exampleTranslation:"Картина висить на стіні.",category:"LOKALE PRÄPOSITIONEN · SATZBAU"},
  {id:"local-contrast-picture-position",targetId:"local-contrast-picture-position",type:"sentence-build",word:"Das Bild hängt an der Wand.",translation:"Картина висить на стіні.",promptText:"an der Wand / das Bild / hängt",response:{mode:"text",scope:"sentence",accepted:["Das Bild hängt an der Wand."],caseSensitive:false,punctuationSensitive:false},explanation:"Hängen here describes a fixed position, so an takes Dativ.",example:"Er hängt das Bild an die Wand.",exampleTranslation:"Він вішає картину на стіну.",category:"LOKALE PRÄPOSITIONEN · SATZBAU"},
  {id:"local-contrast-key",targetId:"local-contrast-key",type:"sentence-build",word:"Sie legt den Schlüssel in die Tasche.",translation:"Вона кладе ключ у сумку.",promptText:"in die Tasche / den Schlüssel / sie / legt",response:{mode:"text",scope:"sentence",accepted:["Sie legt den Schlüssel in die Tasche."],caseSensitive:false,punctuationSensitive:false},explanation:"Legen answers Wohin?, so in takes Akkusativ: in die Tasche.",example:"Der Schlüssel ist in der Tasche.",exampleTranslation:"Ключ у сумці.",category:"LOKALE PRÄPOSITIONEN · SATZBAU"},
  {id:"local-contrast-key-position",targetId:"local-contrast-key-position",type:"sentence-build",word:"Der Schlüssel ist in der Tasche.",translation:"Ключ у сумці.",promptText:"in der Tasche / der Schlüssel / ist",response:{mode:"text",scope:"sentence",accepted:["Der Schlüssel ist in der Tasche."],caseSensitive:false,punctuationSensitive:false},explanation:"Sein answers Wo?, so in takes Dativ: in der Tasche.",example:"Sie legt den Schlüssel in die Tasche.",exampleTranslation:"Вона кладе ключ у сумку.",category:"LOKALE PRÄPOSITIONEN · SATZBAU"},
  {id:"local-contrast-sofa",targetId:"local-contrast-sofa",type:"sentence-build",word:"Ich setze mich auf das Sofa.",translation:"Я сідаю на диван.",promptText:"auf das Sofa / mich / ich / setze",response:{mode:"text",scope:"sentence",accepted:["Ich setze mich auf das Sofa."],caseSensitive:false,punctuationSensitive:false},explanation:"Sich setzen describes movement to a seat, so auf takes Akkusativ.",example:"Ich sitze auf dem Sofa.",exampleTranslation:"Я сиджу на дивані.",category:"LOKALE PRÄPOSITIONEN · SATZBAU"},
  {id:"local-contrast-sofa-position",targetId:"local-contrast-sofa-position",type:"sentence-build",word:"Ich sitze auf dem Sofa.",translation:"Я сиджу на дивані.",promptText:"auf dem Sofa / ich / sitze",response:{mode:"text",scope:"sentence",accepted:["Ich sitze auf dem Sofa."],caseSensitive:false,punctuationSensitive:false},explanation:"Sitzen describes a position, so auf takes Dativ.",example:"Ich setze mich auf das Sofa.",exampleTranslation:"Я сідаю на диван.",category:"LOKALE PRÄPOSITIONEN · SATZBAU"}
];
...
const localPrepositionsStages=[
  {...lessonStep("local-prepositions-dative-learn","Learn Wo? + Dativ","Recognize stationary positions with in, an, auf, über, unter, vor, hinter, neben, and zwischen.",localPrepositionsDativeCards,"learn","Wo? + Dativ","Learn"),requiresFullCoverage:true},
  {...lessonStep("local-prepositions-dative-practice","Practice Wo? + Dativ","Complete each location phrase. Ask Wo? first, then use Dativ after the local preposition.",localPrepositionsDativeCards,"input","Wo? + Dativ","Practice"),requiresFullCoverage:true},
  {...lessonStep("local-prepositions-accusative-learn","Learn Wohin? + Akkusativ","Recognize destinations with the same local prepositions and the accusative article.",localPrepositionsAccusativeCards,"learn","Wohin? + Akkusativ","Learn"),requiresFullCoverage:true},
  {...lessonStep("local-prepositions-accusative-practice","Practice Wohin? + Akkusativ","Complete each destination phrase. Ask Wohin? first, then use Akkusativ after the local preposition.",localPrepositionsAccusativeCards,"input","Wohin? + Akkusativ","Practice"),requiresFullCoverage:true},
  {...lessonStep("local-prepositions-contrast-learn","Compare movement and position","Read matching movement and position sentences. Choose the case from the meaning, not from the preposition alone.",localPrepositionsContrastCards,"learn","Movement or position?","Learn"),requiresFullCoverage:true},
  {...lessonStep("local-prepositions-contrast-practice","Build mixed location sentences","Rebuild the complete sentence and use the correct case for movement or position.",localPrepositionsContrastCards,"input","Movement or position?","Practice"),requiresFullCoverage:true}
];
...
const deckDefinitions={
  ...
  "local-prepositions":{title:"Local prepositions: Dativ & Akkusativ",label:"Local prepositions",badge:"Wo?",tip:"Ask Wo? for a position and Wohin? for a destination. The question decides Dativ or Akkusativ.",guide:{title:"Локальні прийменники: Dativ чи Akkusativ?",intro:"In, an, auf, über, unter, vor, hinter, neben і zwischen можуть стояти з двома відмінками. Відмінок визначає не сам прийменник, а значення: місце чи напрямок.",rules:[{title:"1. Запитайте Wo?",detail:"Якщо щось уже перебуває в певному місці, вживайте Dativ.",formula:"Das Buch liegt in der Schublade. · Die Vase steht auf dem Tisch."},{title:"2. Запитайте Wohin?",detail:"Якщо хтось або щось рухається до місця, вживайте Akkusativ.",formula:"Er legt das Buch in die Schublade. · Ich stelle die Vase auf den Tisch."},{title:"3. Помічайте артикль",detail:"У чоловічому роді Dativ dem і Akkusativ den добре показують різницю. У жіночому та середньому роді форма інколи однакова, але правило не змінюється.",formula:"auf dem Tisch → auf den Tisch · an der Wand → an die Wand"},{title:"4. Вивчайте дієслово разом зі значенням",detail:"Liegen, stehen, sitzen і hängen часто описують місце; legen, stellen, sich setzen і hängen часто описують напрямок.",formula:"Der Hund liegt unter dem Stuhl. · Der Hund läuft unter den Stuhl."}]},cards:[...localPrepositionsDativeCards,...localPrepositionsAccusativeCards,...localPrepositionsContrastCards],stages:localPrepositionsStages},
