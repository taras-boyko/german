...
const pastVerbFormCards=[
  {word:"beginnen (beginnt) · begann · hat begonnen",translation:"починати",category:"VERB FORMS · BEGINNEN",example:"Der Kurs beginnt um neun Uhr.",exampleTranslation:"Курс починається о дев'ятій годині."},
...
const pastVerbPracticeCards=pastVerbFormCards.map(card=>{
...
const everydayVocabularyRoutineCards=[
  ...
  {word:"anfangen",translation:"починати",category:"ALLTAG · VERB",example:"Der Kurs fängt um neun Uhr an.",exampleTranslation:"Курс починається о дев'ятій годині."},
...
const strongVerbStages=[
  lessonStep("strong-verbs-learn","Learn strong verbs","Read the full paradigms for sprechen, fahren, treffen, lesen, essen, and wissen. Notice the stem-vowel changes in singular forms.",strongVerbFormCards,"learn","Strong verbs","Learn"),
  lessonStep("strong-verbs-practice","Practice strong verbs","Enter the missing conjugated form in mixed sentences for all six strong verbs.",strongVerbPracticeCards,"input","Strong verbs","Practice")
];
const pastVerbStages=[
